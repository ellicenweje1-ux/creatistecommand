...
const FAQS = [
  ...
  ['Can I brand my invoices?',
   'Yes. Your logo, business name and brand colour all live in Settings → Business — the “Invoice branding” card has a colour picker (with a live preview) that colours the heading, total and table line on the invoices and quotes your clients see. When building a quote or invoice, use “Add a menu item” to pull a priced dish straight onto a line, or “Add a charge” for delivery/service fees.'],
  ['Can I show my bank details and a thank-you message on invoices?',
   'Yes — in Settings → Business → “Payment details & invoice footer”. Fill in your payment details (bank name, account name, sort code and account number, or a payment link) and they print in their own “Payment details” box on every invoice your clients see. You can also set the closing line at the bottom of the invoice — write your own thank-you message, or leave it blank to use “Thank you for your business.” Both are set once and apply to all your invoices.'],
