...
const FAQS = [
  ...
  ['How do client quote approvals work?',
   'Draft a quote under Finance → Quotes and hit Send. You get a private link to share — your client opens it on their phone, sees the quote beautifully laid out, and taps Approve or Decline. You’re notified instantly. On a booking, tap “Build a quote from this menu” to drop every dish in as a line, then use “Add a charge” to add delivery, mileage, a service fee or anything you’ve saved in Settings → Business. When you’re ready, “Save & create invoice” turns the whole quote into an invoice in one step (with your own numbering). The smoothest flow is menu → quote → invoice, all in here.'],
  ...
  ['Can I edit or reorder items on a shopping list?',
   'Yes. Tap the pencil on any shopping-list item to amend its name, quantity, shop, cost or note. Drag the grip handle to reorder items within a shop (handy to match your route round the aisles). The Shopping page also shows your active bookings at the top, so you can start a list for an upcoming event in one tap.'],
  ['Can I build a route from a shopping list?',
   'Yes. The “Shop” on each shopping-list item is steered from your Suppliers (add them under Suppliers, with addresses). On Routes, open a route and choose “Add stops from a shopping list” — each shop on that list becomes a stop, with its address filled in from your Suppliers, ready to open in Google Maps. No more zig-zagging across town. (In each supplier’s price book, prices are listed A–Z and you can tap the pencil to amend any one.)'],
