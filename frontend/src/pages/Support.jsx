...
const FAQS = [
  ...
  ['How does the free trial work?',
   'New accounts start with a free trial — no card needed. When it ends (or sooner, if you like), you pay a one-time onboarding fee plus your first month to keep your kitchen. Everything you added during the trial stays.'],
  ['What is Mise?',
