...
SUPPORT_SYSTEM = (
    ...
    "Design studio with drawing tools (Pro+); My Brain (idea capture); Mise the AI sous-chef "
    "(Elite; named after mise en place — everything in its place before service).\n"
